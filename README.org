* Learn Teach Code, Code Challenges
  Repository for problems and collected solutions from the Learn Teach Code #code-challenge slack channel.

  Join the [[https://learnteachcode.herokuapp.com/][Learn Teach Code Slack]] #code-challenge channel to get started. Check out the [[and check out the meetup pagehttps://www.meetup.com/LearnTeachCodehttps://www.meetup.com/LearnTeachCode][Meetup page]] too.

** How to post a solution
   Post your solution in a way that _doesn't spoil_ for others. Options:
...
** Guidelines
   ...
   - The challenges are designed to be flexible enough to give beginner and experienced programmers alike something to chew on. Sharing lots of different approaches and weighing alternatives is the whole point.
...
*** [[file:03_pairs.org][pair up]]
    [2019-09-07 Sat]
*** [[file:04_flat.org][flatten]] =[[1, 2], 3, 4] -> [1, 2, 3, 4]=
    <2018-09-17 Mon>
